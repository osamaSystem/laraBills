        ...
        <div class="container ">
            <div class="row fullscreen d-flex align-items-center all-bills-padding-top all-bills-margin-bottom">
                <div class="banner-content col-lg-6 col-md-12 justify-content-center ">
                    <div class="wow fadeInUp title margin-top" data-wow-duration="0.5s" data-wow-delay="0.8s" align="center">إضـافة فاتـورة جديـدة</div>
            ...
            <form method="POST" action="{{url('bills\store')}}">
                @csrf

                <div align="right">
                    <label class="my-1 mr-2 lable-font" for="productId">اختر صنف من القائمة:</label>
                ...
                <div class="form-group" align="right">
                    ...
                    <input type="number" class="form-control" id="amountId" name="amount" onchange="setTotalPrice()" placeholder="العدد المطلوب">
                    @error('amount')
                    <small class = "form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group" align="right">
                    ...
                    <input type="date" class="form-control" id="dateId" name="date" placeholder="حدد تاريخ الفاتورة">
                    @error('date')
                    <small class = "form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group" align="right">
                    ...
                    <input type="text" class="form-control" id="migratorId" name="migrator" placeholder="ادخل الترحيلات هنا">
                    @error('migrator')
                    <small class = "form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group" align="right">
                    ...
                    <input type="text" class="form-control" id="customerId" name="customer" placeholder="ادخل اسم المشتري هنا">
                    @error('customer')
                    <small class = "form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="col-auto my-1">
                    <button type="submit" class="btn2">حـفــظ</button>
                </div>
