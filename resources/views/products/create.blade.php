        ...
        <div class="container">
            <div class="row fullscreen d-flex align-items-center">
                <div class="banner-content col-lg-6 col-md-12 justify-content-center ">
                    <div class="wow fadeInUp title" data-wow-duration="0.5s" data-wow-delay="0.8s" align="center">إضافة صـنـف جديـد</div>
                    ...
                    <form method="POST" action="{{url('products\store')}}">
                        ...
                        <div class="login-content" align="right">
                            ...
                            <input type="text" class="form-control" id="productNameId" name="product_name" placeholder="ادخل الاسم هنا">
                            @error('product_name')
                        ...
                        <div class="form-group" align="right">
                            <label for="productPriceId" class="lable-font" >السعر:</label>
                                <input type="number" class="form-control" id="productPriceId" name="product_price" placeholder="ادخل السعر هنا">
                            @error('product_price')
                            <small class = "form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
